...
insert into departaments(dep_name) values
('directorate'), ('finance_dep'), ('sales_dep'), 
('logistics-dep'), ('legal_dep'), ('HR_dep');

insert into employees(emp_name, dep_id) values
('Ivanov_I.I.', 1), ('Semenova_S.Y.', 2), ('Romanova_E.V.', 6), 
('Kovalev_D.V.', 4),('Volkov_Y.A.', 3), ('Vetrov_G.S.', 5), 
('Mun_V.V.', 5), ('Ermilova_A.S.', 6), ('Nikitin_V.V.', 3);

select * from departaments d left join employees e 
on d.id = e.dep_id;
select * from departaments d right join employees e 
on d.id = e.dep_id;
select * from departaments d full join employees e 
on d.id = e.dep_id;
