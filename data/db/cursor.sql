...
BEGIN;
DECLARE
    cursor_products_back scroll cursor for
                        select * from products;

fetch last from cursor_products_back;
move backward 5 from cursor_products_back;
fetch backward 8 from cursor_products_back;
fetch backward 5 from cursor_products_back;
fetch first from cursor_products_back;
close cursor_products_back;
commit;